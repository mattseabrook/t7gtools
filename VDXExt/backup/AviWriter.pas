...
begin
    ...
    for i := 0 to Bitmaps.count - 1 do begin
       //ExtBitmap := Bitmaps[i];
       ExtBitmap := TBitmap(Bitmaps.Items[i]);
...
begin
  ...
  function AVIFileOpen(pfile: PAVIFILE; szFile: PChar; uMode: LongWord; lpHandler: Pointer): HResult; stdcall; external 'avifil32.dll' name 'AVIFileOpenA';
